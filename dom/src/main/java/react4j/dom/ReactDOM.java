...
public class ReactDOM {
    ...
    @Nullable
    @JsOverlay
    public static Object render(@Nonnull final ReactNode node, @Nonnull final Element container, @Nullable final RenderCallbackFn onUpdate) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }

    @Nullable
    @JsMethod(name = "render")
    private static native Object _render(@Nonnull ReactNode node, @Nonnull Element container, @Nullable RenderCallbackFn onUpdate);
